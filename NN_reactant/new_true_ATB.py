...
with open('uspto/all_rules_ids.pickle', 'rb') as h:  # здесь хранятся в сетах номера всех реакций из uspto.rdf
    # для каждлго правила (для каждого правила свой сет номеров реакций)
    ids = load(h)
