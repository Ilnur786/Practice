#Этот код предназначен для разделения базы негативных примеров на тест и трейн , но работает он с тюплами в которых индексы молекул ( и то со старой базой позитивных примеров которые были сделаны на основе реакций, а не правил)
